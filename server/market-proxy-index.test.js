...
const strip = [
  ...
  { label: '美元', changePct: 0.2, market: 'fx' },
  { label: '港币', changePct: 0.17, market: 'fx' },
];
...
assert('nasdaq100 valuation parts split base and fx', ndx?.valuationParts?.basePct === 1.76 && Math.abs((ndx?.valuationParts?.fxPct ?? 0) - 0.20352) < 0.0001);
